...
# Function to capture system audio output using WASAPI loopback
...
def record_and_save_audio(output_filename_prefix="interleaved_audio", format=pyaudio.paInt16, input_channels=1, output_channels=2, frames_per_buffer=1024, save_interval=20):
    input_queue = queue.Queue()
    output_queue = queue.Queue()

    # Get the default WASAPI loopback device for system audio
    loopback_device = audio.get_default_wasapi_loopback()
